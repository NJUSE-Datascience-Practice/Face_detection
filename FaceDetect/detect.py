...
model = torch.load("./weights/last.pt", map_location=device)['model']
#model = torch.load(weights, map_location=device)
# torch.save(torch.load(weights, map_location=device), weights)  # update model if SourceChangeWarning
# model.fuse()
model.to(device).eval()
def detect(out,source,weights="",conf_thres=0.3,iou_thres=0.5,save_img=False):
...
if __name__ == '__main__':
    detect(out="out",source="D:/Desktop/t",weights="D:\\Desktop\\YOLO\\weights\\last.pt")
    pass
